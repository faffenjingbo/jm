...
public class Summariser extends AbstractTestElement
    ...
    private static String format(String name, SummariserRunningSample summariserRunningSample, String type) {
        ...
        //KafkaProducer.getInstance().send(new TaskProcessingDataDTO.Builder()
        //                    .setActiveThreads(JMeterContextService.getThreadCounts().activeThreads)
        //                    .setStartedThreads(JMeterContextService.getThreadCounts().startedThreads)
        //                    .setFinishedThreads(JMeterContextService.getThreadCounts().finishedThreads)
        //                    .setCounter(summariserRunningSample.getNumSamples())
        //                    .setStartTime(summariserRunningSample.getStartTime())
        //                    .setEndTime(summariserRunningSample.getEndTime())
        //                    .setErrorCount(summariserRunningSample.getErrorCount())
        //                    .setTaskSignkey(JMeterUtils.getProperty("taskSignkey"))
        //                    .build());
        return sb.toString();
    }
