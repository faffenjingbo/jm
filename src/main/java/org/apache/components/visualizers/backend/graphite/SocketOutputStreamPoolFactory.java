...
/**
 * Pool Factory of {@link org.apache.jmeter.visualizers.backend.graphite.SocketOutputStream}
 * @since 2.13
 */
public class SocketOutputStreamPoolFactory
    extends BaseKeyedPooledObjectFactory<org.apache.jmeter.visualizers.backend.graphite.SocketConnectionInfos, SocketOutputStream>
    implements KeyedPooledObjectFactory<org.apache.jmeter.visualizers.backend.graphite.SocketConnectionInfos, SocketOutputStream> {
    ...
    @Override
    public PooledObject<SocketOutputStream> makeObject(org.apache.jmeter.visualizers.backend.graphite.SocketConnectionInfos connectionInfos) throws Exception {
        return wrap(create(connectionInfos));
    }

    @Override
    public void destroyObject(org.apache.jmeter.visualizers.backend.graphite.SocketConnectionInfos socketConnectionInfos, PooledObject<SocketOutputStream> socketOutputStream) throws Exception {
     ...
     */
    @Override
    public boolean validateObject(org.apache.jmeter.visualizers.backend.graphite.SocketConnectionInfos hostAndPort, PooledObject<SocketOutputStream> socketOutputStream) {
