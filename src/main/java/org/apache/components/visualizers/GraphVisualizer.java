...
public class GraphVisualizer extends AbstractVisualizer implements ImageVisualizer, ItemListener, Clearable {
    ...
    private final org.apache.jmeter.visualizers.Graph graph;
     ...
     *            value.
     *
     * @see #createYAxisPanel(String, javax.swing.JTextField)
     *
     ...
     *            label text using {@link org.apache.jmeter.util.JMeterUtils#getResString(String)}.
     *
