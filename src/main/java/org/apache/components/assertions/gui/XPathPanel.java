...
public class XPathPanel extends JPanel {
    ...
    /**
     * Returns the current {@link org.apache.jmeter.gui.util.JSyntaxTextArea} for the xpath expression, or
     * creates a new one, if none is found.
     *
     * @return {@link org.apache.jmeter.gui.util.JSyntaxTextArea} for the xpath expression
     */
