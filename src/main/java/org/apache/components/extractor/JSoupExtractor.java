...
package org.apache.components.extractor;
...
public class JSoupExtractor implements Extractor {
    ...
    private static final String CACHE_KEY_PREFIX = org.apache.jmeter.extractor.JSoupExtractor.class.getName()+"_PARSED_BODY";
    ...
    /**
     * @see org.apache.jmeter.extractor.Extractor#extract(String, String, int, String, java.util.List, int, String)
     */
    @Override
