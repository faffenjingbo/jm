...
package org.apache.components.extractor.json.jsonpath;
                                ...
                                for (Object stringExtracted : extractedValues) {
                                    ...
                                    if (getComputeConcatenation()) {
                                        concat.append(stringExtracted)
                                                .append(org.apache.components.extractor.json.jsonpath.JSONPostProcessor.JSON_CONCATENATION_SEPARATOR);
                                    }
                                    index++;
                                }
                                if (getComputeConcatenation()) {
